...
public class TicketController {
    ...
    @PostMapping("/stat/free")
    public ResponseEntity<List<TicketDto>>getAgentTickets(@RequestParam String airlineName, boolean showSold, @AuthenticationPrincipal Customer customer) {
        return ResponseEntity.ok(service.finadAllForAgent(airlineName, showSold));
    }
